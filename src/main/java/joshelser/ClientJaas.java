 ...
 */
public class ClientJaas extends ClientBase implements ServiceBase {
  private static final Logger log = LoggerFactory.getLogger(ClientJaas.class);
...
//
//    // Parse the options
          opts.parseArgs(ClientJaas.class, args);
