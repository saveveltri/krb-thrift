...
public class ClientHadoop implements ServiceBase {
  ...
  private static class Opts extends ParseBase {
    ...
    @Parameter(names = {"--principal"}, required = true, description = "Client Principal")
    private String principal;

    @Parameter(names = {"--keytab"}, required = true, description = "Client keytab")
  ...
  public static void main(final String[] args) throws Exception {
    ...
    try {
      ...
      UserGroupInformation clientUgi = UserGroupInformation.loginUserFromKeytabAndReturnUGI(opts.principal, opts.keytab);
